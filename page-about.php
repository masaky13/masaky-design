					...
					<div class="row">
						...
						<div class="column">
							<div class="title">
								...
								<p>主にHTML/CSSコーダー・グラフィックデザイナーとして活動しております。web制作ではWordPress が得意でテーマの制作や入稿追加機能、データベースの管理や一括置換、API連携など、フロントエンドからバックエンドまで幅広く改修・開発ができます。また、web制作プロジェクトのディレクターを任されたこともあるためチームでの開発も臨機応変に対応可能です。落語のイベントの総合マネジャーの経験もあり、様々な分野で挑戦し活躍したいと考えております。</p>
                <div class="profile-info list-style-slash">
                  <p>
                    <span>千葉県出身</span><span>O型</span><span>ふたご座</span>
                  </p>
                  <p>Hobbies<br>
